...
// App palette, per theme so bubbles stay visible on either background.
// Dark theme: pale fill + brand-blue outline (glows on the dark bg).
// Light theme: strong blue fill + deep-navy outline (reads on the light bg).
const DARK_FILL = '#dbeafe';
const DARK_STROKE = '#3b82f6';
const LIGHT_FILL = '#1e40af';
...
class Particle {
  ...
  update(context: CanvasRenderingContext2D) {
    ...
    context.fillStyle = isLight ? LIGHT_FILL : DARK_FILL;
    context.strokeStyle = isLight ? LIGHT_STROKE : DARK_STROKE;
    context.beginPath();
    context.arc(
